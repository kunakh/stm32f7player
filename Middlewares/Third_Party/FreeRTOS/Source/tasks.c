 ...
 */
static void prvInitialiseTCBVariables( TCB_t * const pxTCB, const char * const pcName, UBaseType_t uxPriority, const MemoryRegion_t * const xRegions, const uint32_t usStackDepth ) PRIVILEGED_FUNCTION; /*lint !e971 Unqualified char types are allowed for strings and single characters only. */
 ...
 */
static TCB_t *prvAllocateTCBAndStack( const uint32_t usStackDepth, StackType_t * const puxStackBuffer ) PRIVILEGED_FUNCTION;
...
static void prvInitialiseTCBVariables( TCB_t * const pxTCB, const char * const pcName, UBaseType_t uxPriority, const MemoryRegion_t * const xRegions, const uint32_t usStackDepth ) /*lint !e971 Unqualified char types are allowed for strings and single characters only. */
{
UBaseType_t x;
...
static TCB_t *prvAllocateTCBAndStack( const uint32_t usStackDepth, StackType_t * const puxStackBuffer )
{
TCB_t *pxNewTCB;
