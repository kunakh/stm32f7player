...
void ScaleYCbCrToRGB565(register const uint8_t *y_buf,
                        register const uint8_t *u_buf,
                        register const uint8_t *v_buf,
                        register uint8_t *rgb_buf,
                        int source_width,
                        int source_height,
                        register int width,
                        int height,
                        register int y_pitch,
                        int uv_pitch,
                        int rgb_pitch,
                        YUVType yuv_type) {
  register int source_x0_q16;
  register int source_y0_q16;
  register int source_dx_q16;
  register int source_dy_q16;
  int source_uv_xoffs_q16;
  register int source_uv_yoffs_q16;
  int x_shift;
  int y_shift;
  int ymin;
  int ymax;
